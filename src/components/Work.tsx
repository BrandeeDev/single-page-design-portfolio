    ...
    return(
        <div className="flex flex-col justify-center items-center my-[100px] sm:my-[120px] lg:my-[88px] " >
            ...
            <div className="flex flex-row gap-x-[15px] mt-8 sm:mt-[56px] sm:gap-x-[30px]">
                <img src={slides[index.previous] } className="w-[270px] h-[180px] overflow-visible ml-[-233px] rounded-xl sm:ml-[-495px] sm:w-[540px] sm:h-[360px]"/>
                <img src={slides[index.current]} className=" w-[270px] h-[180px] rounded-xl sm:w-[540px] sm:h-[360px]" />
                <img src={slides[index.next]} className="w-[270px] h-[180px] overflow-visible mr-[-232px] sm:mr-[-495px] rounded-xl sm:w-[540px] sm:h-[360px]"/>
            </div>
